...
set.seed(42)
in_dir_ = '../data/integration/healthy/immune/lymphoid/'
out_dir_ = '../out/integration/healthy/immune/lymphoid/'
fl_nm = 'Milo_DA_k30_d30_prop0.4_lymphoid'
pdf(file = paste0(out_dir_,'/',fl_nm,'_stats.pdf'), width = 10, height = 10)
